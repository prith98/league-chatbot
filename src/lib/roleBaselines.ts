...
const BASELINES: Record<Role, RoleBaseline> = {
  TOP: { kda: 2.4, kp: 50, damageShare: 22, csPerMin: 6.5, dpm: 600, goldPerMin: 380, deathShare: 20 },
  JUNGLE: { kda: 2.6, kp: 65, damageShare: 20, csPerMin: 5.2, dpm: 550, goldPerMin: 370, deathShare: 20 },
  MIDDLE: { kda: 2.7, kp: 62, damageShare: 27, csPerMin: 7.0, dpm: 750, goldPerMin: 410, deathShare: 19 },
  BOTTOM: { kda: 2.7, kp: 60, damageShare: 28, csPerMin: 7.5, dpm: 780, goldPerMin: 420, deathShare: 19 },
  UTILITY: { kda: 2.8, kp: 65, damageShare: 12, csPerMin: 1.3, dpm: 350, goldPerMin: 250, deathShare: 22 },
};
